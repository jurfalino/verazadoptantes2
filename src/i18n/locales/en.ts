export const en = {
    ...
    adopter: {
        ...
        vis_modal_locked_sub: 'Only the record owner, their organization, and people with approved access can see the contact.',
        vis_modal_locked_body: 'This data wasn\'t public, so it\'s protected. You can ask the record owner for access; we\'ll notify you when they respond.',
