export const en = {
    ...
    walkthrough: {
        ...
        step_type_body: 'Type from memory the name of the last person you adopted an animal out to.',
        step_run_title: 'Run the search',
        step_run_body: 'Hit search (or press Enter) to look them up.',
