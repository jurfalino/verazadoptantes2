export const en = {
    ...
    admin: {
        ...
        nav_sect_panel: 'Dashboard',
        nav_sect_moderation: 'Moderation',
        nav_sect_requests: 'Requests',
        nav_sect_admin: 'Administration',
        nav_sect_system: 'System & audit',
        nav_mod_accessible: 'Also accessible to moderators',
    ...
    login: {
        ...
        email_code_hint: 'We\'ll email you a 6-digit code to sign in.',
        code_sent: 'We sent a code to',
        code_label: '6-digit code',
        verify_btn: 'Sign in',
        code_invalid: 'Wrong or expired code. Check it or request a new one.',
    ...
    errors: {
        ...
        stale_banner_title: 'A new version is available',
        stale_banner_body: 'We updated the app while this tab was open. Reload to continue. If you were typing something, copy it first: reloading clears it.',
        stale_banner_action: 'Reload',
    ...
    dialogs: {
        ...
        delete_record_title: 'Delete this record?',
        delete_record_last_link: 'This is the only record for {animal}. If you continue, the animal will also be moved to the trash.',
        delete_record_animal_kept: '{animal} will stay in My Animals.',
        delete_record_keep_animal: 'Delete only the record',
        delete_record_delete_both: 'Delete both',
    ...
    search: {
        ...
        summary_shown: '{total} matches · showing {shown}',
        summary_total: '{count} results',
        summary_refine: 'Add a last name or phone to narrow it down',
        summary_for: 'for “{query}”',
        none_match_kicker: 'If they are not here, they are missing',
        none_match_q: 'None of these match?',
        none_match_named: 'Add {name} yourself. Every record you add helps another rescuer find them next time.',
        none_match_generic: 'Add this person yourself, with whatever details you have. Every record you add helps another rescuer find them next time.',
        none_match_caution: 'Check carefully first: if they are already here, a duplicate splits their history.',
        create_named: 'Add {name}',
        create_generic: 'Add adopter',
        ...
        protected_unlocked_label: 'You have access',
    ...
    adopter: {
        ...
        current_profile_photo: 'Current photo',
        ...
        ce_input_ph_social_facebook: 'facebook.com/username or profile link',
        ce_input_ph_social_instagram: '@username or link',
        ce_input_ph_social_tiktok: '@username or link',
        ce_input_ph_social_x: '@username or link',
        ce_input_ph_social_threads: '@username or link',
        ce_input_ph_social_other: 'URL or username',
        ce_input_ph_id: 'DNI / Document number',
        ce_input_ph_address: 'Street, city, province',
        ce_social_which: 'Which network is it?',
        ce_phone_apps: 'Messaging:',
        ...
        vis_modal_public_title: 'Public record',
        vis_modal_public_sub: 'Visible to anyone, even without signing in. Contact details are in the open.',
        vis_modal_public_why: 'Why it\'s public',
        vis_modal_source_title: 'Data origin',
        vis_modal_locked_title: 'Contact details are protected',
        vis_modal_locked_sub: 'BuenAdoptante protects adopters\' personal information.',
        vis_modal_locked_body: 'You can verify details you already have and the system will reveal the info if it confirms a match; you can also request access from the record owner, explaining your reason.',
        vis_modal_verify_btn: 'Verify a detail I already have',
        vis_modal_request_pending: 'Request pending approval.',
        vis_modal_unlocked_title: 'You have access to this record',
        vis_reason_owner: 'You can see the contact details because you\'re the record owner.',
        vis_reason_org: 'You can see the contact details because you belong to {org}.',
        vis_reason_org_fallback: 'your organization',
        vis_reason_admin: 'You can see the contact details because you\'re an admin.',
        vis_reason_privileged: 'You can see the contact details because you have a role with access.',
        vis_reason_grant: 'The owner granted you full access to the contact details.',
        vis_grant_note: 'The record owner can revoke your access at any time. You can\'t see who else has access to this record.',
        ...
        pii_grants_search_title: 'Unlocked via search match',
        ...
        hh_rel: 'Relationship',
        hh_rel_choose: 'Choose…',
        hh_rel_none: 'No relationship',
        hh_rel_unknown_display: 'Relationship unknown',
        hh_rel_partner: 'Partner',
        hh_rel_child: 'Child',
        hh_rel_parent: 'Parent',
    ...
    animalProfile: {
        ...
        share_intent_contract_adopted: 'If you want to resend the contract or save the signed copy',
        share_intent_record: 'If you want to record an adoption that already happened',
        event_photos: 'Photos',
        event_rating: 'Rating',
        ...
        share_title: 'Share',
        add_event: 'Add event',
        add_event_hint: 'It goes on the animal\'s line of life.',
        event_type: 'Type',
        event_date: 'Date',
        event_details: 'Details',
        event_details_ph: 'E.g.: 5-in-1 vaccine, first dose',
        event_saved: 'Event saved',
        event_save_failed: 'Could not save the event.',
        event_type_follow_up: 'Follow-up with the family',
        event_type_vaccination: 'Vaccination',
        event_type_deworming: 'Deworming',
        event_type_vet_visit: 'Vet visit',
        event_type_neuter: 'Neutering',
        event_type_note: 'Note',
        timeline_title: 'Line of life',
        timeline_empty: 'No events on the line of life yet.',
        verb_adopted_m: 'Adopted by',
        verb_adopted_f: 'Adopted by',
        verb_foster_start: 'Entered foster with',
        verb_foster_end: 'Foster ended with',
        verb_adoption_end: 'Adoption ended with',
        verb_followup: 'Follow-up with',
        verb_returned_m: 'Returned by',
        verb_returned_f: 'Returned by',
        days: 'days',
        species_cat_m: 'Cat',
        species_cat_f: 'Cat',
        species_dog_m: 'Dog',
        species_dog_f: 'Dog',
        castrated_m: 'neutered',
        castrated_f: 'neutered',
        ...
        status_adopted_m: 'Adopted by',
        status_adopted_f: 'Adopted by',
        record_foster: 'Record foster',
        ...
        delete_confirm_body: 'This deletes the animal with its whole line of life: placements, events and photos. This cannot be undone.',
        delete_confirm_cta: 'Yes, delete',
        edit_hint: 'Identity only. Custody and health are recorded from the profile.',
        edit_save_failed: 'Could not save the changes.',
        field_name: 'Name',
        field_species: 'Species',
        field_sex: 'Sex',
        field_age: 'Estimated age',
        field_age_unit: 'Unit',
        field_color: 'Color',
        field_microchip: 'Microchip',
        no_microchip: 'No microchip',
        field_neutered: 'Already neutered',
        field_details: 'Description',
        field_details_ph: 'Personality, markings, history…',
        months: 'months',
        years: 'years',
        view_animal: 'View animal profile',
        applicant_one: 'interested',
        applicant_many: 'interested',
        saving: 'Saving…',
        saved: 'Saved',
        deleting: 'Deleting…',
        read_more: 'read more',
    ...
    followups: {
        ...
        health_vaccines: 'Vaccine plan (puppy/kitten)',
        health_neuter: 'Neutering (≈6 months of age)',
        checkin_custom: 'Day-{days} check-in',
        foster_checkin: 'Foster check-in (day {days})',
        status_due: 'Due',
        ...
        pending_one: 'due',
        pending_many: 'due',
        tg_copied_title: 'Message copied',
        tg_copied: 'Paste it into the Telegram chat (it cannot prefill text).',
        subtype: 'Subtype',
        subtype_adaptation: 'Adaptation',
        subtype_vaccination: 'Vaccination',
        subtype_neuter: 'Neutering',
        subtype_vet_visit: 'Vet',
        settings_title: 'Adoption follow-ups',
        settings_hint: 'Applies to all your adoptions: you define how many check-ins and when. Changes apply on save.',
        settings_save_failed: 'Could not save the schedule.',
        checkin_at: 'Check-in at',
        remove: 'Remove',
        add_checkin: 'Add check-in',
        toggle_vaccines: 'Remind vaccine plan for puppies/kittens',
        toggle_neuter: 'Remind neutering near 6 months',
        toggle_foster: 'Foster check-ins, every',
        messages_title: 'Follow-up messages',
        messages_hint: 'They open prefilled in WhatsApp (or are copied for Telegram) when contacting the family. Variables: {animal}, {familia}, {dias}.',
    ...
    walkthrough: {
        ...
        finish: 'Got it',
        skip: 'Skip',
        modal_title: 'How to check an adopter',
        search_placeholder: 'Search an adopter…',
        search_button: 'Search',
        demo_search_title: 'Check before you hand over an animal',
        demo_search_body: 'Before giving an animal in adoption or foster, you search the person right here.',
        demo_typed_title: 'Search a name',
        demo_typed_body: 'For example, let’s search “Juan”.',
        demo_results_title: 'Three results',
        demo_results_body: 'The search found three people named Juan. Each card sums up how trustworthy they are. Let’s look at them one by one.',
        demo_bueno_title: 'Juan BuenAdoptante: a good sign',
        demo_bueno_body: 'Rating 4: the community vouches for him. His address is verified (✓), too. This is the kind of adopter you want.',
        demo_protegido_title: 'Their data is protected',
        demo_protegido_body: 'Notice his phone and address appear hidden. Phone, address, and social networks are only visible to the person who created the record (and their group). Others can only validate what they already have: if you search or enter his phone and it matches, you’ll see it; otherwise you won’t.',
