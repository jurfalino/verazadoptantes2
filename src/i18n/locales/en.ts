export const en = {
    ...
    adopter: {
        ...
        contrib_modal_title: 'Add a contact detail',
        contrib_modal_body: 'Your contribution will appear on the profile and the creator and editors will be notified. Your name is logged.',
        contrib_modal_type_label: 'Type',
        contrib_modal_value_label: 'Value',
        contrib_modal_value_ph: 'Type the detail',
        contrib_modal_submit: 'Add',
        contrib_modal_cancel: 'Cancel',
        contrib_added_toast: 'Contact detail added',
        contrib_error: 'Could not add the detail.',
