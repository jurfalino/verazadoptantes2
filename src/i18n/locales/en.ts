export const en = {
    ...
    features: {
        ...
        hero_title: 'Everything you need to protect your animals',
        hero_subtitle: 'The free platform used by rescuers and shelters to vet adopters, share information, and prevent irresponsible adoptions.',
        hero_cta: 'Get started free',
        hero_cta_guide: 'See the adoption guide',
        pain_title: 'Stop losing information',
        pain1_before: 'Spreadsheets get lost, outdated, and nobody maintains them.',
        pain1_after: 'Search across all registered adopters instantly.',
        pain2_before: 'WhatsApp chats disappear and information gets lost.',
        pain2_after: 'Share from any app and AI extracts the data.',
        pain3_before: 'No way to know if someone already adopted before.',
        pain3_after: 'Full adoption history with ratings and alerts.',
        feat_search_title: 'Deep Search',
        feat_search_desc: 'Search by name, phone, or history. Instant results across all adopters registered by you and your team.',
        feat_import_title: 'Import from your phone',
        feat_import_desc: 'Install the app on your phone, share a post from Instagram, Facebook, or WhatsApp, and AI automatically extracts names, phone numbers, animals, and more.',
        feat_dashboard_title: 'Dashboard',
        feat_dashboard_desc: 'All your adopters, adoptions, and animals in one place. Filter by record type, review statistics, and manage your database.',
        feat_orgs_title: 'Organizations',
        feat_orgs_desc: 'Create a team and invite members with a simple link. Everyone sees all team records, tagged with who added them.',
