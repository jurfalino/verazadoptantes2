export const en = {
    ...
    import: {
        ...
        tabText: '📝 Text',
        tabImages: '📷 Images',
        urlLabel: 'Paste any URL',
        urlPlaceholder: 'https://facebook.com/... or any website',
        urlHint: 'Works with Facebook posts, Instagram, news articles, or any web page',
        fetchButton: 'Fetch & Extract',
        fetching: 'Fetching content...',
        textLabel: 'Paste text content',
        textPlaceholder: 'Paste the adoption announcement, WhatsApp message, or any text with adopter information...',
        continueBtn: 'Continue',
        imageLabel: 'Upload screenshots or photos',
        imageDropzone: 'Click to upload images',
        imageHint: 'Screenshots of posts, chat messages, etc.',
        continueWithImages: 'Continue with',
        image: 'image',
        images: 'images',
