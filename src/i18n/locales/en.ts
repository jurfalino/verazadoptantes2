export const en = {
    ...
    walkthrough: {
        ...
        finish: 'Got it',
        skip: 'Skip',
        step_type_title: 'Search before you hand over an animal',
        step_type_body: "Type the name of the adopter you want to check. It can be someone you're about to give an animal to (adoption or foster), or someone you already did. Then press Search.",
        step_rating_title: 'Their rating',
        step_rating_body: "This badge is the adopter's average rating from the community.",
        step_flags_title: 'Warning flags',
        step_flags_body: 'These chips flag concerns — too many adoptions, possible duplicates, or a verified identity.',
        step_history_title: 'Their history',
        step_history_body: 'Views, requests and adoptions summarize their activity. Tap a card to open the full profile.',
        no_results_title: 'No match found',
        no_results_body: "That's fine — try a name you know is already in the system, or tap “Show me how to search” to try again.",
    },
};
