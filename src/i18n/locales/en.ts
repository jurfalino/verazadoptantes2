export const en = {
    ...
    features: {
        ...
        pain1_before: 'You have adopters in spreadsheets, notebooks, and WhatsApp chats. Nothing is centralized.',
        pain1_after: 'One place to search by name, phone, or adoption history.',
        pain2_before: 'Someone posted an adoption on Instagram. Copying the data by hand takes time.',
        pain2_after: 'Install the app, share the post, and AI extracts names, phones, and animal details.',
        pain3_before: 'You don\'t know if the person contacting you already adopted (or returned) from another shelter.',
        pain3_after: 'Every adopter has a profile with ratings, history, and alerts from other rescuers.',
        ...
        feat_import_title: 'Import straight from social media',
        feat_import_desc: 'Install BuenAdoptante on your phone as an app. When you see an adoption post on Instagram, Facebook, or WhatsApp, tap "Share" and pick BuenAdoptante. AI reads the text and extracts data automatically.',
        ...
        feat_forms_title: 'Adoption Forms',
        feat_forms_desc: 'Shareable forms with QR codes. Responses are automatically linked to the adopter profile.',
        trust_free: '100% Free',
