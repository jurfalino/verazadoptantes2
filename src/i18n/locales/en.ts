export const en = {
    ...
    import: {
        ...
        public_profile_off: 'This profile will be private (your organization only)',
        public_profile_explainer: 'The data comes from a public source (social network). Disable this if you want it kept private.',
    ...
    walkthrough: {
        ...
        demo_revealresult_title: 'Their data, revealed',
        demo_revealresult_body: 'Because the phone matches this record, you now see its full details — email, phone, and address. Only what you already knew is revealed.',
