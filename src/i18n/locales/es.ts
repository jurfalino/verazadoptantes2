export const es = {
    ...
    admin: {
        ...
        flag_desc_contact_import: 'Mostrar el botón "Contactos del teléfono" en la portada para crear un perfil eligiendo un contacto de la agenda del dispositivo. Solo aparece donde el selector del sistema existe, que hoy es Chrome en Android; en el resto de los navegadores queda oculto. Por defecto desactivado.',
    ...
    login: {
        ...
        email_code_hint: 'Te enviaremos un código de 6 dígitos para ingresar.',
        code_sent: 'Enviamos un código a',
        code_label: 'Código de 6 dígitos',
        verify_btn: 'Ingresar',
        code_invalid: 'Código incorrecto o vencido. Revisalo o pedí uno nuevo.',
        invalid_email: 'Ese email no parece válido.',
        rate_limited: 'Demasiados intentos. Probá de nuevo en un rato.',
        retry_in: 'Probá de nuevo en',
    ...
    errors: {
        ...
        stale_banner_title: 'Hay una versión nueva',
        stale_banner_body: 'Actualizamos la app mientras tenías esta pestaña abierta. Recargá para seguir. Si estabas escribiendo algo, copialo antes: al recargar se pierde.',
        stale_banner_action: 'Recargar',
    ...
    dialogs: {
        confirm_delete_member: '¿Eliminar a "{name}" del grupo familiar?',
        confirm_delete_member_unnamed: '¿Eliminar a este integrante del grupo familiar?',
        confirm_delete_contact: '¿Eliminar "{value}"?',
        confirm_delete_contact_note: 'Este dato de contacto se eliminará del perfil.',
        confirm_delete_member_note: 'También se eliminarán todos sus datos de contacto.',
        ...
        delete_record_title: '¿Eliminar este registro?',
        delete_record_last_link: 'Es el único registro de {animal}. Si continuás, el animal también se moverá a la papelera.',
        delete_record_animal_kept: '{animal} seguirá en Mis Animales.',
        delete_record_keep_animal: 'Eliminar solo el registro',
        delete_record_delete_both: 'Eliminar ambos',
    ...
    search: {
        ...
        summary_shown: '{total} coincidencias · mostrando {shown}',
        summary_total: '{count} resultados',
        summary_refine: 'Sumá un apellido o teléfono para acotar',
        summary_for: 'para “{query}”',
        none_match_kicker: 'Si no está acá, falta',
        none_match_q: '¿Ninguna coincide?',
        none_match_named: 'Agregá a {name} vos. Cada registro que sumás ayuda a que otro rescatista la encuentre la próxima vez.',
        none_match_generic: 'Agregá a esta persona vos, con los datos que ya tenés. Cada registro que sumás ayuda a que otro rescatista la encuentre la próxima vez.',
        none_match_caution: 'Revisá bien antes: si ya está cargada, duplicarla parte su historial.',
        create_named: 'Agregar a {name}',
        create_generic: 'Agregar adoptante',
    ...
    home: {
        ...
        action_import_contacts_btn: 'Contactos del teléfono',
        ...
        action_import_contacts_secondary: 'Importar desde los contactos del teléfono',
    ...
    animalProfile: {
        ...
        photo_failed: 'El evento se guardó, pero una foto no se pudo subir.',
        team: 'equipo',
        of_teammate: 'de',
        origin_m: 'Rescatado y registrado',
        origin_f: 'Rescatada y registrada',
        origin_in: 'en',
        back: 'Mis animales',
        share: 'Compartir',
        share_title: 'Compartir',
        add_event: 'Agregar evento',
        add_event_hint: 'Queda en la línea de vida del animal.',
        event_type: 'Tipo',
        event_date: 'Fecha',
        event_details: 'Detalle',
        event_details_ph: 'Ej.: quíntuple, primera dosis',
        event_saved: 'Evento guardado',
        event_save_failed: 'No se pudo guardar el evento.',
        event_type_follow_up: 'Seguimiento a la familia',
        event_type_vaccination: 'Vacunación',
        event_type_deworming: 'Desparasitación',
        event_type_vet_visit: 'Visita al veterinario',
        event_type_neuter: 'Castración',
        event_type_note: 'Nota',
        timeline_title: 'Línea de vida',
        timeline_empty: 'Todavía no hay eventos en la línea de vida.',
        verb_adopted_m: 'Adoptado por',
        verb_adopted_f: 'Adoptada por',
        verb_foster_start: 'Entró en tránsito con',
        verb_foster_end: 'Terminó el tránsito con',
        verb_adoption_end: 'Terminó la adopción con',
        verb_followup: 'Seguimiento a',
        verb_returned_m: 'Devuelto por',
        verb_returned_f: 'Devuelta por',
        days: 'días',
        species_cat_m: 'Gato',
        species_cat_f: 'Gata',
        species_dog_m: 'Perro',
        ...
        status_adopted_m: 'Adoptado por',
        status_adopted_f: 'Adoptada por',
        record_foster: 'Registrar tránsito',
        ...
        delete_confirm_body: 'Se borra el animal con toda su línea de vida: tenencias, eventos y fotos. Esta acción no se puede deshacer.',
        delete_confirm_cta: 'Sí, eliminar',
        edit_hint: 'Solo la identidad. La tenencia y la salud se registran desde la ficha.',
        edit_save_failed: 'No se pudieron guardar los cambios.',
        field_name: 'Nombre',
        field_species: 'Especie',
        field_sex: 'Sexo',
        field_age: 'Edad estimada',
        field_age_unit: 'Unidad',
        field_color: 'Color',
        field_microchip: 'Microchip',
        no_microchip: 'Sin microchip',
        field_neutered: 'Ya está castrado/a',
        field_details: 'Descripción',
        field_details_ph: 'Carácter, señas, historia…',
        months: 'meses',
        years: 'años',
        view_animal: 'Ver ficha del animal',
        applicant_one: 'interesada',
        applicant_many: 'interesadas',
        saving: 'Guardando…',
        saved: 'Guardado',
        deleting: 'Eliminando…',
        read_more: 'leer más',
    ...
    followups: {
        ...
        health_vaccines: 'Plan de vacunas (cachorro)',
        health_neuter: 'Castración (≈6 meses de edad)',
        checkin_custom: 'Control del día {days}',
        foster_checkin: 'Control de tránsito (día {days})',
        ...
        tg_copied_title: 'Mensaje copiado',
        tg_copied: 'Pegalo en el chat de Telegram (no acepta texto pre-armado).',
        subtype: 'Subtipo',
        subtype_adaptation: 'Adaptación',
        subtype_vaccination: 'Vacunación',
        subtype_neuter: 'Castración',
        subtype_vet_visit: 'Veterinario',
        settings_title: 'Seguimientos de adopción',
        settings_hint: 'Vale para todas tus adopciones: definís cuántos controles hacés y cuándo. Los cambios se aplican al guardar.',
        settings_save_failed: 'No se pudo guardar el cronograma.',
        checkin_at: 'Control a los',
        remove: 'Quitar',
        add_checkin: 'Agregar control',
        toggle_vaccines: 'Recordar plan de vacunas en cachorros',
        toggle_neuter: 'Recordar castración cerca de los 6 meses',
        toggle_foster: 'Controles durante el tránsito, cada',
        messages_title: 'Mensajes de seguimiento',
        messages_hint: 'Se abren pre-armados en WhatsApp (o se copian para Telegram) al contactar a la familia. Variables: {animal}, {familia}, {dias}.',
        restore_defaults: 'Restaurar por defecto',
    },
    myAnimals: {
        date_registered: 'Registrado el',
        date_fostered: 'En tránsito desde el',
        date_adopted: 'Adoptado el',
    ...
    import: {
        ...
        missing_post_text: 'No pudimos leer el texto de esta publicación: Facebook no lo comparte, probablemente porque no es pública. Guardamos el enlace y lo que sí pudimos traer (foto, nombre); podés borrarlo o escribir el texto vos. El perfil se va a importar como protegido.',
        removeImage: 'Descartar esta foto',
        public_profile_explainer_private_source: 'La publicación de origen no es visible públicamente, así que este perfil se importa protegido. Activá esta opción solo si verificaste que la fuente es pública.',
        source_not_public: 'No pudimos leer esta publicación porque no es visible públicamente en Facebook. Guardamos el enlace y podés pegar el texto y/o capturas de pantalla manualmente. El perfil se va a importar como protegido, porque la fuente no era pública.',
        ...
        attachedImages: 'Imágenes adjuntas',        mediaExclude: 'Quitar',        mediaInclude: 'Incluir',
        notes: 'Notas',
    ...
    pendingSearches: {
        ...
        subtitle: 'Buscaste a estas personas y no quedó registro. Abrilas para contar qué pasó.',
        searched_times: '{count} búsquedas · {when}',
        searched_once: 'Buscaste "{query}" {when}',
        searched_once_short: 'Buscaste {when}',
        matches: 'Coincide con {name}',
        option_search_again: 'Buscar de nuevo',
