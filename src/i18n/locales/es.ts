export const es = {
    ...
    import: {
        ...
        public_profile_off: 'Este perfil quedará privado (solo tu organización)',
        public_profile_explainer: 'Los datos vienen de una fuente pública (red social). Si preferís que sean privados, desactivá esta opción.',
