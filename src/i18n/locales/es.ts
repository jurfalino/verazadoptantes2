export const es = {
    ...
    adopter: {
        ...
        contrib_modal_title: 'Agregar dato de contacto',
        contrib_modal_body: 'Tu aporte va a aparecer en el perfil y se notifica al creador y a los editores. Tu nombre queda registrado.',
        contrib_modal_type_label: 'Tipo',
        contrib_modal_value_label: 'Valor',
        contrib_modal_value_ph: 'Ingresá el dato',
        contrib_modal_submit: 'Agregar',
        contrib_modal_cancel: 'Cancelar',
        contrib_added_toast: 'Dato de contacto agregado',
        contrib_error: 'No se pudo agregar el dato.',
