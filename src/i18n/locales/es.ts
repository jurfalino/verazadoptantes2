export const es = {
    ...
    features: {
        ...
        pain1_before: 'Tenés adoptantes en planillas, cuadernos y chats de WhatsApp. Nada está centralizado.',
        pain1_after: 'Un solo lugar para buscar por nombre, teléfono, o historial de adopción.',
        pain2_before: 'Alguien publicó un post de adopción en Instagram. Copiar los datos a mano lleva tiempo.',
        pain2_after: 'Instalá la app, compartí el post, y la IA extrae nombre, teléfono y datos del animal.',
        pain3_before: 'No sabés si la persona que te contacta ya adoptó (o devolvió) en otro refugio.',
        pain3_after: 'Cada adoptante tiene un perfil con calificación, historial y alertas de otros rescatistas.',
        ...
        feat_import_title: 'Importá directo desde redes sociales',
        feat_import_desc: 'Instalá BuenAdoptante en tu celular como una app. Cuando veas un post de adopción en Instagram, Facebook o WhatsApp, tocá "Compartir" y elegí BuenAdoptante. La IA lee el texto y extrae los datos automáticamente.',
        ...
        feat_forms_title: 'Formularios de Adopción',
        feat_forms_desc: 'Formularios compartibles con código QR. Las respuestas se vinculan automáticamente al perfil del adoptante.',
