export const es = {
    ...
    walkthrough: {
        ...
        step_type_body: 'Escribí de memoria el nombre de la última persona a la que le diste un animal en adopción.',
        step_run_title: 'Hacé la búsqueda',
        step_run_body: 'Tocá buscar (o apretá Enter) para consultarlo.',
