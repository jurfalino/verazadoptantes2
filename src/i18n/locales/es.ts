export const es = {
    ...
    walkthrough: {
        ...
        finish: 'Entendido',
        skip: 'Saltar',
        step_type_title: 'Verificá antes de entregar un animal',
        step_type_body: 'Escribí el nombre del adoptante que querés verificar. Puede ser una persona a quien le estás por dar un animal en adopción —o tránsito—, o alguien a quien ya le diste. Luego presioná Buscar.',
        step_rating_title: 'Su calificación',
        step_rating_body: 'Esta insignia es la calificación promedio del adoptante según la comunidad.',
        step_flags_title: 'Alertas',
        step_flags_body: 'Estos chips marcan señales: demasiadas adopciones, posibles duplicados o identidad verificada.',
        step_history_title: 'Su historial',
        step_history_body: 'Vistas, solicitudes y adopciones resumen su actividad. Tocá una tarjeta para abrir el perfil completo.',
        no_results_title: 'Sin coincidencias',
        no_results_body: 'No pasa nada — probá con un nombre que sepas que ya está en el sistema, o tocá “Mostrame cómo buscar” para reintentar.',
    },
};
