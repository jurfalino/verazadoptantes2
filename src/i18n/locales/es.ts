export const es = {
    ...
    adopter: {
        ...
        vis_modal_locked_sub: 'Solo el responsable, su organización y quienes tengan acceso aprobado pueden ver el contacto.',
        vis_modal_locked_body: 'Estos datos no eran públicos, así que se protegen. Podés pedirle acceso al responsable del registro; te avisamos cuando responda.',
