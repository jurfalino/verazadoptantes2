export const es = {
    ...
    import: {
        ...
        stepReview: 'Revisar',
        // Paso 1: Pestañas de entrada
        tabUrl: '🔗 URL',
        tabText: '📝 Texto',
        tabImages: '📷 Imágenes',
        urlLabel: 'Pegar cualquier URL',
        urlPlaceholder: 'https://facebook.com/... o cualquier sitio web',
        urlHint: 'Funciona con posts de Facebook, Instagram, noticias o cualquier página web',
        fetchButton: 'Obtener y Extraer',
        fetching: 'Obteniendo contenido...',
        textLabel: 'Pegar texto',
        textPlaceholder: 'Pegá el anuncio de adopción, mensaje de WhatsApp, o cualquier texto con información del adoptante...',
        continueBtn: 'Continuar',
        imageLabel: 'Subir capturas o fotos',
        imageDropzone: 'Hacé clic para subir imágenes',
        imageHint: 'Capturas de posts, mensajes de chat, etc.',
        continueWithImages: 'Continuar con',
        image: 'imagen',
        images: 'imágenes',
