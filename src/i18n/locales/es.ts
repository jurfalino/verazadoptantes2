export const es = {
    ...
    animalProfile: {
        ...
        share_hint: 'El formulario suma personas interesadas; el contrato se firma con quien elijas.',
        share_hint_adopted: 'Reenviá el contrato o guardá la constancia firmada.',
