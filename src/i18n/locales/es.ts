export const es = {
    ...
    features: {
        ...
        hero_title: 'Todo lo que necesitás para proteger a tus animales',
        hero_subtitle: 'La plataforma gratuita que usan rescatistas y refugios para verificar adoptantes, compartir información y prevenir adopciones irresponsables.',
        hero_cta: 'Empezar gratis',
        hero_cta_guide: 'Ver la guía de adopción',
        pain_title: 'Dejá de perder información',
        pain1_before: 'Las planillas se pierden, se desactualizan y nadie las mantiene.',
        pain1_after: 'Buscá entre todos los adoptantes registrados al instante.',
        pain2_before: 'Los chats de WhatsApp desaparecen y la información se pierde.',
        pain2_after: 'Compartí desde cualquier app y la IA extrae los datos.',
        pain3_before: 'No hay forma de saber si alguien ya adoptó antes.',
        pain3_after: 'Historial completo de adopciones con calificaciones y alertas.',
        feat_search_title: 'Búsqueda Profunda',
        feat_search_desc: 'Buscá por nombre, teléfono o historial. Resultados instantáneos entre todos los adoptantes registrados por vos y tu equipo.',
        feat_import_title: 'Importá desde tu celular',
        feat_import_desc: 'Instalá la app en tu teléfono, compartí una publicación de Instagram, Facebook o WhatsApp, y la inteligencia artificial extrae nombre, teléfono, animal y más automáticamente.',
        feat_dashboard_title: 'Panel de Control',
        feat_dashboard_desc: 'Todos tus adoptantes, adopciones y animales en un solo lugar. Filtrá por tipo de registro, revisá estadísticas y gestioná tu base de datos.',
        feat_orgs_title: 'Organizaciones',
        feat_orgs_desc: 'Creá un equipo e invitá miembros con un simple enlace. Todos ven los registros de todo el equipo, con el nombre de quién los agregó.',
