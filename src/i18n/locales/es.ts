export const es = {
    ...
    walkthrough: {
        ...
        demo_protegido_body: 'Fijate que su teléfono y dirección aparecen ocultos. El nombre, el teléfono, la dirección y las redes solo son visibles para quien cargó el registro (y su grupo). Otros solo validan lo que ya tienen: si buscás o cargás su teléfono y coincide, lo verás; si no, no.',
