export const es = {
    ...
    adopter: {
        ...
        ce_visibility_all_public: 'Estos datos vienen de una fuente pública y son visibles para todos.',
        ce_visibility_mixed: 'Los datos marcados como públicos son visibles para todos. El resto solo es visible para vos y tus organizaciones.',
        ce_public_badge: 'Público',
        ce_public_badge_title: 'Este dato fue importado de una fuente pública y es visible para todos.',
