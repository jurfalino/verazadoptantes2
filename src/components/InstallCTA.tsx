        ...
        <div className="mt-10 mx-auto max-w-md">
            <div className="rounded-2xl p-5 text-center" style={{ background: 'var(--surface-card)', border: '1px solid var(--border-default)' }}>
                ...
                <div className="space-y-2 mb-4 text-left">
                    {benefits.map((b, i) => (
                        <div key={i} className="flex items-center gap-2.5 px-3 py-1.5 rounded-lg" style={{ background: 'var(--surface-muted)' }}>
                ...
                {/* Action */}
                {isIOS ? (
                    <p className="text-xs rounded-lg px-3 py-2" style={{ color: 'var(--text-muted)', background: 'var(--surface-muted)' }}>
