...
```
Compare the count against the threshold of **123**. If the count is **higher than 123**, STOP and tell the user:
> "⚠️ Lint warnings increased from 123 to [N]. You should fix the new warnings before deploying, or acknowledge the increase."
