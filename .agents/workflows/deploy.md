...
2. Run lint warning ratchet check (current threshold: **122 warnings**):
// turbo
```
npx next lint 2>&1 | Select-String "Warning:" | Measure-Object | Select-Object -ExpandProperty Count
```
Compare the count against the threshold of **122**. If the count is **higher than 122**, STOP and tell the user:
